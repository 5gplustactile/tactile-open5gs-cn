...
POD_NAME_UE2=$(kubectl get pods -l "app.kubernetes.io/instance=ueransim-gnb-dnn1" -o jsonpath={.items[1].metadata.name})
...
SCRIPT_PATH="/root/naas-discovery-open5gs/naas-discovery-open5gs/open5gs/values/scripts/hitraffic20_gNB1.sh"
